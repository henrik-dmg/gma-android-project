...
import htw.gma_sose22.metronompro.MainActivity
import htw.gma_sose22.metronompro.R
...
class MetronomeService : Service() {
    ...
    private fun startForegroundNotification() {
        ...
        val notification: Notification = Notification.Builder(this, CHANNEL_ID)
            .setContentTitle(getText(R.string.title_metronome))
            .setContentText(getText(R.string.title_editor))
            .setSmallIcon(R.drawable.ic_launcher_foreground)
            .setLargeIcon(Icon.createWithResource(this, R.drawable.ic_dashboard_black_24dp))
